...
const steps = [
  ...
  },
  {
    ...
    desc: <>Documented patterns become testimony, FOIA requests, DOJ complaints, and Virginia General Assembly evidence through IRN's JFV legislative partnership. <br /><br /><a href="/irn-criminal-injustice/campaigns/" style={{color: '#D4A843', fontWeight: 500, textDecoration: 'underline'}}>View the Newport News Community Safety & Equity Act kit →</a></>,
    visual: (
      <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
